package com.vearad.vearatick.model.db
...
interface ProjectDao : BaceDao<Project> {
    ...
    @Query("SELECT * FROM project_table WHERE doneProject = :doneProject AND noDeadlineProject = :noDeadline")
    fun getAllNoDoneProject(doneProject: Boolean,noDeadline: Boolean): List<Project>
