...
class CompanyEventFragment : Fragment() {
    ...
    lateinit var companyEventData: List<EventsResponse.Event>
    ...
    private fun getEvent(user: String?, accessToken: String?, apiService: ApiService) {
        ...
        if (user != null && accessToken != null) {
            ...
            call.enqueue(object : Callback<EventsResponse>, CompanyEventAdapter.CompanyEventEvent {
                override fun onResponse(call: Call<EventsResponse>, response: Response<EventsResponse>) {
                    if (response.isSuccessful) {
                        ...
                        val eventData: EventsResponse? = response.body()
    ...
    private fun bottomMargin(companyEventData: List<EventsResponse.Event>) {
